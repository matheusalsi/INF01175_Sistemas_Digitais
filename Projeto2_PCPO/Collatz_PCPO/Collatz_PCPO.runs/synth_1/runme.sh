...
HD_PWD='D:/source/Github/INF01175_Sistemas_Digitais/Projeto2_PCPO/Collatz_PCPO/Collatz_PCPO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Collatz_VHDL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Collatz_VHDL.tcl
