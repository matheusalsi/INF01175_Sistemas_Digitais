...
HD_PWD='D:/source/Github/INF01175_Sistemas_Digitais/Projeto2_PCPO/Collatz_PCPO/Collatz_PCPO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Collatz_VHDL.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Collatz_VHDL.tcl -notrace
